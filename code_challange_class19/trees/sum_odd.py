...
class BinarySearchTree(BinaryTree):
    ...
    def sum_odd_numbers(self, node):
        """
        Calculate the sum of all odd numbers in the binary search tree.
        ...
        sum_odd += self.sum_odd_numbers(node.left)
        sum_odd += self.sum_odd_numbers(node.right)
...
sum_of_odd = bst.sum_odd_numbers(bst.root)
